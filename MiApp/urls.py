...
urlpatterns = [
    ...
    path('supermercadoLista/', views.SupermercadoLista.as_view(), name='supermercados'),
    path('supermercadoDetalle/<int:pk>/', views.SupermercadoDetalle.as_view(), name='supermercado'),
    path('supermercadoEdicion/<int:pk>/', views.SupermercadoUpdate.as_view(), name='editar_supermercado'),
    path('supermercadoBorrado/<int:pk>/', views.SupermercadoDelete.as_view(), name='eliminar_supermercado'),
    path('hogarLista/', views.HogarLista.as_view(), name='hogars'),
    path('hogarDetalle/<int:pk>/', views.HogarDetalle.as_view(), name='hogar'),
    path('hogarEdicion/<int:pk>/', views.HogarUpdate.as_view(), name='editar_hogar'),
    path('hogarBorrado/<int:pk>/', views.HogarDelete.as_view(), name='eliminar_hogar'),
    path('ropaesteticaLista/', views.RopaEsteticaLista.as_view(), name='ropaesteticas'),
    path('ropaesteticaDetalle/<int:pk>/', views.RopaEsteticaDetalle.as_view(), name='ropaestetica'),
    path('ropaesteticaEdicion/<int:pk>/', views.RopaEsteticaUpdate.as_view(), name='editar_ropaestetica'),
    path('ropaesteticaBorrado/<int:pk>/', views.RopaEsteticaDelete.as_view(), name='eliminar_ropaestetica'),
]